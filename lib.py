...
def lindetrend(x, time, mode='cutted'):
    ...
    - 'sigma' = perform a sigma clip around the source and makes a linear fit of the uncutted data
    - 'cutted' = cutting the firsts and lasts 300 elements of the timestream and makes a linear fit on this data
    '''
