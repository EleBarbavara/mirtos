...
class SkydipCalibration:
    ...
    def plot_hist(self):
        ...
        ax1.vlines(self.med_resp, ymin=min(hst[0]), ymax=max(hst[0]) + 10, color="k", ls="dashed",
                   label="Median = " + str(round(self.med_resp, 3)) + " rad/K")
...
if __name__ == "__main__":
    ...
    skydip_003_001_fits = "/Volumes/Data/PycharmProjects/mirtos/data/input/20250402-222030-MISTRAL-GAIN_CAL/20250402-222030-MISTRAL-GAIN_CAL_003_001.fits"
    skydip_005_001_fits = "/Volumes/Data/PycharmProjects/mirtos/data/input/20250402-000651-MISTRAL-GAIN_CAL/20250402-000651-MISTRAL-GAIN_CAL_005_001.fits"

    sdp_003_001_cal = SkydipCalibration(skydip_003_001_fits, T_atm, tau)
    sdp_005_001_cal = SkydipCalibration(skydip_005_001_fits, T_atm, tau)

    for sdp_cal, skydip_fits in zip([sdp_003_001_cal, sdp_005_001_cal], [skydip_003_001_fits, skydip_005_001_fits]):

        expected_path = "/Volumes/Data/PycharmProjects/mirtos/tests/data/skydipcalibration/expected_skydip_cal_" + skydip_fits.split("/")[-1].replace(".fits", "")
